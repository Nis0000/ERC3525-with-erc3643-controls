...
//  import "@openzeppelin/contracts/token/ERC721/extensions/ERC721URIStorage.sol";
 import "contracts/token/IERC721.sol";
import "contracts/token/IERC3525.sol";
import "contracts/token/IERC721Receiver.sol";
import "contracts/token/IERC3525Receiver.sol";
import "contracts/extensions/IERC721Enumerable.sol";
import "contracts/extensions/IERC721Metadata.sol";
import "contracts/extensions/IERC3525Metadata.sol";
import "contracts/periphery/interface/IERC3525MetadataDescriptor.sol";
import "@openzeppelin/contracts/utils/Base64.sol";

//imports of erc3643 features
import "@onchain-id/solidity/contracts/interface/IIdentity.sol";
// import "contracts/token/IToken.sol";
import "contracts/token/TokenStorage.sol";
import "contracts/roles/AgentRoleUpgradeable.sol";

contract ERC3525 is  IERC3525Metadata, IERC721Enumerable,TokenStorage,AgentRoleUpgradeable {
...
// atempting erc3643 control in transfer
    function transferFrom(
        address from_,
        address to_,
        uint256 tokenId_
        ...
        require(!_frozen[to_] && !_frozen[from_], "wallet is frozen");
         if (_tokenIdentityRegistry.isVerified(to_) && _tokenCompliance.canTransfer(msg.sender, to_,1)){
...
.getApproved(tokenId_) == operator_
    ...
    function _mint(address to_, uint256 tokenId_, uint256 slot_, uint256 value_) public virtual {
